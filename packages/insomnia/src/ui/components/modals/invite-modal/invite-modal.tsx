        ...
        {member.type === 'group' && (
          <div className="flex min-w-[88px] items-center justify-center">
            <Button
              ...
              className="pressed:bg-(--color-surprise)/40 flex min-w-[70px] cursor-pointer items-center justify-center gap-2 rounded-xs bg-(--color-surprise) bg-clip-padding p-1 text-sm text-(--color-font-surprise) outline-hidden transition-all hover:bg-(--color-surprise)/80 focus-visible:ring-2 focus-visible:ring-white/75"
              onPress={() => {
